<?php
	...
	class HashAuthorizer extends Authorizer implements \Players\Model\I\IHashAuthorizer {
        ...
        public function set( $key, array $data ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t set data for '. $this->name . $key );
                return false;
            }
        }
