<?php
	...
	class Set extends Base implements \Players\Model\I\ISet {
        ...
        public function append( $key, $member ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t append data to '. $this->name . $key .' ['. $member .']' );
            }
            return false;
        }
        ...
        public function exists( $key, $member ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->logException( $E );
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t find data of '. $this->name . $key .' ['. $member .']' );
            }
            return false;
        }
        ...
        public function remove( $key, $member ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->logException( $E );
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t remove data from '. $this->name . $key .' ['. $member .']' );
            }
            return false;
        }
        ...
        public function clear( $key ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->logException( $E );
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t clear data from '. $this->name . $key );
            }
            return false;
        }
        ...
        public function members( $key ){
            try {
                ...
                \Players\System\Registry::instance()->Logger()->logException( $E );
                \Players\System\Registry::instance()->Logger()->log( 'redis-errors', 'Couldn\'t get data from '. $this->name . $key );
                return false;
            }
        }
